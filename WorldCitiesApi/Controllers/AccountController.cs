...
namespace WorldCitiesApi.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(UserManager<ParkingUser> userManager, JwtHandler jwtHandler)
        {
        ...
        {
            ParkingUser? user = await _userManager.FindByNameAsync(loginRequest.UserName);
